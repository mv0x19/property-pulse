                ...
                <main>
                  ...
                  <div className='mt-6 rounded-lg bg-white p-6 shadow-md'>
                    ...
                    <ul className='grid list-none grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                      ...
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Full kitchen
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Washer & Dryer
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Free Parking
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Hot Tub
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>24/7 Security
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Wheelchair
                        Accessible
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Elevator Access
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Dishwasher
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Gym/Fitness Center
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Air Conditioning
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Balcony/Patio
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Smart TV
                      </li>
                      <li>
                        <i className='fas fa-check mr-2 mt-3 text-green-600'></i>Coffee Maker
                      </li>
                    </ul>
                  </div>
                  <div className='mt-6 rounded-lg bg-white p-6 shadow-md'>
